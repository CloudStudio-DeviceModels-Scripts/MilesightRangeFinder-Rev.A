...
# Parsing + Configuration Script – Milesight Range Finder - Rev. A

This **Parsing + Configuration** script is designed for the **Milesight Range Finder** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – Milesight Range Finder Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **Milesight Range Finder** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
